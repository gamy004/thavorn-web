  ...
  computed: {
    ...
    formatingDatetime: function formatingDatetime() {
      return function (datetime, format) {
        ...
        return moment__WEBPACK_IMPORTED_MODULE_0___default()(datetime).add(543, 'year').format(format);
      };
    }
  }
};
...
/*!**************************************!*\
  !*** ./resources/js/mixins/index.js ***!
  \**************************************/
/*! exports provided: datetimeMixin, searchMixin */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _datetimeMixin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./datetimeMixin */ "./resources/js/mixins/datetimeMixin.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "datetimeMixin", function() { return _datetimeMixin__WEBPACK_IMPORTED_MODULE_0__["datetimeMixin"]; });

/* harmony import */ var _searchMixin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./searchMixin */ "./resources/js/mixins/searchMixin.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "searchMixin", function() { return _searchMixin__WEBPACK_IMPORTED_MODULE_1__["searchMixin"]; });
...
var searchMixin = {
  models: [_models_Pawn__WEBPACK_IMPORTED_MODULE_1__["default"], _models_User__WEBPACK_IMPORTED_MODULE_3__["default"], _models_PawnItem__WEBPACK_IMPORTED_MODULE_2__["default"]],
  data: function data() {
    return {
      searchInput: "",
      search: false,
  ...
  computed: {
    ...
    user: function user() {
      return Object(lodash__WEBPACK_IMPORTED_MODULE_4__["groupBy"])(_models_User__WEBPACK_IMPORTED_MODULE_3__["default"].query().get(), function (user) {
        return user.id;
      });
    },
    pawnItems: function pawnItems() {
      return _models_PawnItem__WEBPACK_IMPORTED_MODULE_2__["default"].query().get();
    },
    pawnItemsByPawnID: function pawnItemsByPawnID() {
      return Object(lodash__WEBPACK_IMPORTED_MODULE_4__["groupBy"])(_models_PawnItem__WEBPACK_IMPORTED_MODULE_2__["default"].query().get(), function (pawn_item) {
  ...
  methods: {
    ...
    sumPawnItemValueByPawnNo: function sumPawnItemValueByPawnNo(id) {
      ...
      var sumItemValue = Object(lodash__WEBPACK_IMPORTED_MODULE_4__["sumBy"])(this.pawnItemByPawnNo(id), 'item_value');
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                _context.prev = 3;
                this.search = true;
                this.loading = true; // let { response } = await this.fetchPawnItems(this.searchInput, ["pawn_no", "first_name", "last_name", "identity_card_id"]);
              ...
              case 8:
                ...
                _context.next = 13;
                return this.fetchUserPawn(this.searchInput, ["full_name", "identity_card_id"]);
