<template>
  <span>
    <span class="d-inline-block mr-2" id="tooltipSuccessWrapper">
      <button
        class="btn bg-neutral-success text-success font-size-lg p-0 d-inline-block shadow-none text-center d-44 rounded position-relative"
    ...
    >
      <div class="row no-gutters">
        <div class="col-lg-5">
          <div
            class="hero-wrapper bg-composed-wrapper bg-plum-plate h-100 rounded-left"
          >
            <div class="flex-grow-1 w-100 d-flex align-items-center">
              <div
                class="bg-composed-wrapper--image rounded-left"
                :style="{
                  backgroundImage:
                    'url(' +
                    require('../../../assets/img/hero-bg/hero-1.jpg') +
                    ')',
                }"
              ></div>
              <div
                class="bg-composed-wrapper--bg bg-second opacity-5 rounded-left"
              ></div>
              <div class="bg-composed-wrapper--content p-5">
                <div class="d-flex align-items-center">
                  <span class="badge badge-pill badge-second px-4 h-auto py-1"
                    >New release</span
                  >
                  <span
                    class="text-white-50 pl-3"
                    v-b-tooltip.hover
                ...
                <div class="text-white mt-3">
                  ...
                  <div>
                    <a href="javascript:void(0);" class="btn btn-warning">
                      <span class="btn-wrapper--label"> Browse gallery </span>
        ...
        <div class="col-lg-7">
          <b-tabs pills nav-class="nav-line mx-3 my-4">
                  ...
                  <div class="card-body">
                    <div class="text-left">
                      ...
                      <div class="mt-3 line-height-sm">
                        <b class="font-size-lg text-black pr-1">3,568</b>
              ...
              <div class="card shadow-none border-0">
                <div class="card-header bg-white pb-5">
                  ...
                  <div class="text-center">
                    <b-button variant="facebook" class="mr-2">
                      <span class="btn-wrapper--icon">
                        <font-awesome-icon :icon="['fab', 'facebook']" />
                      </span>
                      <span class="btn-wrapper--label"> Facebook </span>
                    </b-button>
                    <b-button variant="twitter" class="ml-2">
                      <span class="btn-wrapper--icon">
                        <font-awesome-icon :icon="['fab', 'twitter']" />
                      </span>
                      <span class="btn-wrapper--label"> Twitter </span>
                    </b-button>
                  </div>
                </div>
                <div class="card-body bg-secondary rounded px-lg-5 py-lg-5">
                  ...
                  <form role="form">
                    <b-form-group>
                      <b-input-group>
                        ...
                        <b-input-group-text slot="prepend">
                          <font-awesome-icon class="mx-auto" icon="envelope" />
                        </b-input-group-text>
                      </b-input-group>
                    </b-form-group>
                    <b-form-group>
                    ...
                    <div class="text-center">
                      <b-button variant="second" class="my-4">Sign in</b-button>
                    </div>
                  </form>
                </div>
              </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="card card-box mb-5">
                      ...
                      <div class="card-body px-4 py-3">
                        <div class="pb-3 d-flex justify-content-between">
                          <a href="javascript:void(0);"> Create UI mockups </a>
                        </div>
                        <div
                          class="d-flex align-items-center justify-content-start"
                        >
                ...
                <div class="timeline-list mb-5">
                  <div class="timeline-item timeline-item-icon">
                    <div class="timeline-item--content">
                      <div
                        class="timeline-item--icon-wrapper bg-danger text-white"
                      >
                  ...
                  <div class="timeline-item">
                    <div class="timeline-item--content">
                      ...
                      <h4 class="timeline-item--label mb-2 font-weight-bold">
                        ...
                        <span class="badge badge-neutral-info text-info ml-2"
                          >New</span
                        >
                      </h4>
                      <p>
    ...
    <button
      ...
      type="button"
      id="popoverIntegrExample4"
    >
      <span class="badge badge-circle badge-danger badge-header-alt"
        >Online</span
      >
    ...
    <b-popover
      triggers="click blur"
      placement="bottom"
      custom-class="popover-custom-wrapper popover-custom-lg popover-secondary"
      target="popoverIntegrExample4"
    >
      <ul class="list-group list-group-flush text-left bg-transparent">
        <li class="list-group-item rounded-top">
          <div class="align-box-row">
            ...
            <div class="pl-2">
              ...
              <small class="pb-1 text-black-50 d-block"
                >John's bio description here...</small
              >
        ...
        <li class="list-group-item bg-transparent py-2">
          <div class="align-box-row mb-1">
            ...
            <div class="ml-auto">
              <div class="font-weight-bold text-success">348</div>
            </div>
          </div>
          <div class="progress-bar-sm progress-bar-animated-alt progress w-100">
            <div
              class="progress-bar bg-success w-43"
              role="progressbar"
              aria-valuenow="43"
              aria-valuemin="0"
              aria-valuemax="100"
    ...
    <button
      type="button"
      class="btn bg-neutral-first text-first font-size-lg mr-2 p-0 d-inline-block shadow-none text-center d-44 rounded"
      id="popoverIntegrExample3"
    >
    ...
    <b-popover
      ...
      placement="bottom"
      custom-class="popover-custom-wrapper popover-custom-lg popover-secondary"
      target="popoverIntegrExample3"
    >
      <div class="px-3 pt-3 pb-3 text-center">
        <div class="m-3 d-inline-block text-center">
          <a
            href="javascript:void(0);"
            class="btn btn-link p-0 bg-ripe-malin d-inline-block text-center text-white font-size-xl d-50 rounded border-0 mb-2"
          >
        ...
        <div class="m-3 d-inline-block text-center">
          <a
            href="javascript:void(0);"
            class="btn btn-link p-0 bg-grow-early d-inline-block text-center text-white font-size-xl d-50 rounded border-0 mb-2"
          >
        ...
        <div class="m-3 d-inline-block text-center">
          <a
            href="javascript:void(0);"
            class="btn btn-link p-0 bg-arielle-smile d-inline-block text-center text-white font-size-xl d-50 rounded border-0 mb-2"
          >
...
export default {
  ...
  methods: {
    ...
    showPopoverIntegrations() {
      this.$refs.popoverIntegrations4._toolpop
        .getTipElement()
        .classList.add(
      ...
      this.$refs.popoverIntegrations3._toolpop
        .getTipElement()
        .classList.add(
          "popover-custom-wrapper",
          "popover-custom-lg",
