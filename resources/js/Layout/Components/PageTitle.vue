    ...
    <div class="row">
      ...
      >
        <div class="mx-auto mx-xl-0">
          <b-dropdown
            variant="primary"
            class="dropdown-menu-xl mr-3 pb-0"
            right
            no-caret
          >
            <template slot="button-content">
              <font-awesome-icon icon="bell" />
              <span class="badge badge-warning ml-3"><b>23</b> New</span>
            </template>
            ...
            <VuePerfectScrollbar
              class="scrollbar-container scroll-area-sm"
              v-once
            >
              <div class="p-3">
                <div class="timeline-list">
                  <div class="timeline-item timeline-item-icon">
                    <div class="timeline-item--content">
                      <div
                        class="timeline-item--icon-wrapper bg-primary text-white"
                      >
                  ...
                  <div class="timeline-item timeline-item-icon">
                    <div class="timeline-item--content">
                      <div
                        class="timeline-item--icon-wrapper bg-amy-crisp text-white"
                      >
          ...
          <a
            href="https://docs.uifort.com/bamburgh-vue-admin-dashboard-bootstrap-vue-pro-docs/"
