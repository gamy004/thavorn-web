                                        ...
                                        <div v-show="true">
                                            ...
                                            <table class="table table-hover table-striped table-bordered mt-3 mb-5">
                                                ...
                                                <tr v-for="(extend, index) in extendTemps" :key="`extend-${index}`">
                                                    ...
                                                    <td>
                                                        <button @click.prevent="pawnReply(extend.pawn_on)" class="btn btn-success btn-sm ml-3">ไถ่ถอน</button>
                                                        
                                                        <!-- Modal สรุปรายการไถ่ถอน -->
                                                        <b-modal :id="`pawn-reply-modal-${extend.pawn_on}`" no-close-on-backdrop>
                                                            ...
                                                            <template slot="modal-footer" class="modal-footer ml-3 mr-3">
                                                                <button type="button" class="btn btn-secondary" @click="closePawnReply(extend.pawn_on)">
