        ...
        <div class="page-title page-title--alt">
            <div class="row">
                <div class="col-xl-7 d-block d-xl-flex align-items-center">
                    ...
                    <div>
                        <h5 class="display-4 mt-1 mb-2 font-weight-bold">ต่ออายุดอกเบี้ย</h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card card-box">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="form-row">
                                    <label class="col-md-12" for="inputCustomerInfo">ค้นหาจากฐานข้อมูลลูกค้า</label>
                                </div>
                                <div class="form-row">
                                    ...
                                    <b-form-group class="col-sm-2"> 
                                        <button @click.prevent="searchExtend" class="btn btn-primary btn-md">ค้นหา</button>
                                    </b-form-group>
                                </div>
                                <div class="row mt-5">
                                    <div class="col-xl-12 d-block">
                                        <h4 v-show="true" style="text-align:center" class="text-black-50">กรุณากรอกข้อมูลเพื่อทำการค้นหา</h4>
                                        <h4 v-show="true" style="text-align:center" class="text-black-50">ไม่พบข้อมูลที่ต้องการ กรุณาตรวจสอบความถูกต้องอีกครั้ง</h4>
                                        <div v-show="true">
                                                    ...
                                                    <td>
                                                        ...
                                                        <b-modal :id="`pawn-detail-modal-${extend.pawn_on}`">
                                                            ...
                                                            <template slot="modal-footer" class="modal-footer ml-3 mr-3">
                                                                <button type="button" class="btn btn-secondary" @click="closePawnDetail(extend.pawn_on)">
                                                                    <a class="ft-s-16">ปิดหน้าต่าง</a>
                                                                </button>
                                                                <button type="button" class="btn btn-primary" @click="pawnRenew(extend.pawn_on)">
                                                        ...
                                                        <b-modal :id="`pawn-renew-modal-${extend.pawn_on}`">
                                                                ...
                                                                <div class="row mb-4" >
                                                                    <div class="col-12">
                                                                        ...
                                                                        <div class="card card-box mt-2 mb-5">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="datepicker-wrapper-flush" data-toggle="datepicker"></div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <template slot="modal-footer" class="modal-footer ml-3 mr-3">
                                                                <button type="button" class="btn btn-secondary" @click="closePawnRenew(extend.pawn_on)">
                                                                    <a class="ft-s-16">ปิดหน้าต่าง</a>
                                                                </button>
